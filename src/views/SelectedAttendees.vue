<template>
    <div class="w-screen]">
        <div class="mx-5 text-black justify-between flex flex-col md:flex-row gap-3 w-full md:w-full lg:w-1/2 md:mx-auto mt-4"
            >
            <router-link
                class="bg-white text-black px-4 w-full py-3 rounded-lg border-none"
                to="/">Home</router-link>
            <router-link
                class="bg-white text-black px-4 w-full py-3 rounded-lg border-none"
